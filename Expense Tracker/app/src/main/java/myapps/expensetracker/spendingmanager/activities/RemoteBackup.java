...
//
//import static myapps.expensetracker.spendingmanager.activities.Settings_Screen.REQUEST_CODE_CREATION;
//import static myapps.expensetracker.spendingmanager.activities.Settings_Screen.REQUEST_CODE_OPENING;
//import static myapps.expensetracker.spendingmanager.activities.Settings_Screen.REQUEST_CODE_SIGN_IN;
//
//
...
//        if (account == null) {
//            Log.d("checkAccount","null");
//            Toast.makeText(activity, "account", Toast.LENGTH_SHORT).show();
//            signIn();
//        } else {
//            Toast.makeText(activity, "account not sign in", Toast.LENGTH_SHORT).show();
//            Log.d("checkAccount","not null");
...
//        Toast.makeText(activity, "startSignIN", Toast.LENGTH_SHORT).show();
...
//
//                        e -> Log.d("checkContents", "Failed to create new contents.", e)
//
//
//
//                );
